...
class PDFCreator {
	...
	private Font bigBold = new Font(Font.FontFamily.TIMES_ROMAN, 24,
			Font.BOLD);
	/**
...
//    }  
	...
	protected void addScheduleContent(Document document, ScheduleScheme schedule)
		...
		// Fharplanname
		Paragraph scheduleName = new Paragraph("Fahrplanname:  " + schedule.getID(), smallBold);
		// Fahrplantyp
		Paragraph scheduleType = new Paragraph("Fahrplantyp:  "
				+ schedule.getScheduleType(), smallBold);
		// Erster Fahrtag
		Paragraph firstDay = new Paragraph("Erster Fahrtag :  "
				+ getWeekDay(schedule.getFirstRide().DAY_OF_WEEK) + ", den "
		...
		Paragraph lastDay = new Paragraph("Letzter Fahrtag :  "
				+ schedule.getLastRide(), smallBold);
		...
		Paragraph intervall = new Paragraph("Intervall :  "
				+ schedule.getInterval(), smallBold);
		// Streckennetz
